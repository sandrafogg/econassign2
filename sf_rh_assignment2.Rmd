...
gas_df
```
###Supply, Demand, and Marginal Externality Costs for Gasoline in France
...
###Costs and Benefits at Status Quo
...
###Costs and Benefits with a $0.50/gallon Tax
...
rev_mtaxes <- q_mtaxes*(p_mtaxes-price_sq)
rev_mtaxes 
