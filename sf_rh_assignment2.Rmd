...
#q_aggregategph_equil<- function(q){P_aggb+P_aggm*q - 5}
#q_aggregategph_equil
#Find the area under the curve via integrating
#aggregate_cs <- integrate(q_aggregategph_equil, 0, 267217.062558)
#aggregate_cs 
# = 2365754
######### needed?
...
benefits_difference = cs_equil_h - cs_equil_l
benefits_difference
# = $238678.5
```
